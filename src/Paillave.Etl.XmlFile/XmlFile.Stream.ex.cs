...
namespace Paillave.Etl.XmlFile
{
    ...
    {
        public static IStream<XmlNodeParsed> CrossApplyXmlFile(this IStream<IFileValue> stream, string name, Func<XmlFileDefinition, XmlFileDefinition> map, bool noParallelisation = false)
        {
