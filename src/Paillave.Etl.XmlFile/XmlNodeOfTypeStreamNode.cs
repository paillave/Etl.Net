...
public class XmlNodeOfTypeStreamNode<TOut>(string name, XmlNodeOfTypeFileArgs<TOut> args) : StreamNodeBase<TOut, IStream<TOut>, XmlNodeOfTypeFileArgs<TOut>>(name, args)
{
...
public class XmlNodeOfTypeCorrelatedStreamNode<TOut>(string name, XmlNodeOfTypeCorrelatedFileArgs<TOut> args) : StreamNodeBase<Correlated<TOut>, IStream<Correlated<TOut>>, XmlNodeOfTypeCorrelatedFileArgs<TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
