...
public class XmlFileValuesProvider(XmlFileValuesProviderArgs args) : ValuesProviderBase<IFileValue, XmlNodeParsed>
{
    private readonly XmlFileValuesProviderArgs _args = args;
