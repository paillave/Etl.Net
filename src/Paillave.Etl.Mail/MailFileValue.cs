...
public class MailFileValue : FileValueBase<MailFileValueMetadata>
{
    ...
    public MailFileValue(IMailConnectionInfo connectionInfo, string folder, string fileName, string connectorCode, string connectorName, string connectionName, bool setToReadIfBatchDeletion, string mailSubject, DateTime receivedDate, uint messageId, Dictionary<string, bool> deleted)
