...
namespace Paillave.Etl.TextFile
{
    ...
    internal class BooleanTypeConverter : TypeConverter
    {
        ...
        public BooleanTypeConverter(string[] trueValues, string[] falseValues)
        {
            _trueValue = trueValues.FirstOrDefault();
            _falseValue = falseValues.FirstOrDefault();
            _trueValues = trueValues.ToHashSet(StringComparer.InvariantCultureIgnoreCase);
            _falseValues = falseValues.ToHashSet(StringComparer.InvariantCultureIgnoreCase);
        }
