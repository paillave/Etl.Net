...
namespace Paillave.Etl
{
    public static class StreamExTf
    {
        ...
        public static IStream<TOut> CrossApplyTextFile<TOut>(this IStream<string> stream, string name, FileDefinition<TOut> args, bool noParallelisation = false)
            where TOut : new()
        {
        ...
        public static IStream<TOut> CrossApplyTextFile<TOut>(this IStream<Stream> stream, string name, FileDefinition<TOut> args, bool noParallelisation = false)
            where TOut : new()
        {
        ...
        public static IStream<TOut> CrossApplyTextFile<TIn, TOut>(this IStream<TIn> stream, string name, FileDefinition<TOut> args, Func<TIn, string> filePathSelector, bool noParallelisation = false)
            where TOut : new()
        {
        ...
        public static IStream<TOut> CrossApplyTextFile<TIn, TParsed, TOut>(this IStream<TIn> stream, string name, FileDefinition<TParsed> args, Func<TIn, string> filePathSelector, Func<TIn, TParsed, TOut> resultSelector, bool noParallelisation = false) where TParsed : new()
        {
        ...
        public static IStream<TOut> CrossApplyTextFile<TParsed, TOut>(this IStream<string> stream, string name, FileDefinition<TParsed> args, Func<string, TParsed, TOut> resultSelector, bool noParallelisation = false) where TParsed : new()
        {
        ...
        public static IStream<TOut> CrossApplyTextFile<TParsed, TOut>(this IStream<Stream> stream, string name, FileDefinition<TParsed> args, Func<TParsed, TOut> resultSelector, bool noParallelisation = false) where TParsed : new()
        {
        ...
        #region ToTextFile
        public static IStream<TIn> ToTextFile<TIn>(this IStream<TIn> stream, string name, IStream<SystemIO.StreamWriter> resourceStream, FileDefinition<TIn> mapping) where TIn : new()
        {
        ...
        public static ISortedStream<TIn, TKey> ToTextFile<TIn, TKey>(this ISortedStream<TIn, TKey> stream, string name, IStream<SystemIO.StreamWriter> resourceStream, FileDefinition<TIn> mapping) where TIn : new()
        {
        ...
        public static IKeyedStream<TIn, TKey> ToTextFile<TIn, TKey>(this IKeyedStream<TIn, TKey> stream, string name, IStream<SystemIO.StreamWriter> resourceStream, FileDefinition<TIn> mapping) where TIn : new()
        {
