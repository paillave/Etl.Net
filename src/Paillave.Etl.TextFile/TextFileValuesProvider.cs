...
public class TextFileValuesProvider<TOut>(TextFileValuesProviderArgs<TOut> args) : ValuesProviderBase<IFileValue, TOut>
{
    private readonly TextFileValuesProviderArgs<TOut> _args = args;
