...
public class S3FileValueProcessor : FileValueProcessorBase<S3AdapterConnectionParameters, S3AdapterProcessorParameters>
{
    ...
    protected override void Process(IFileValue fileValue, S3AdapterConnectionParameters connectionParameters, S3AdapterProcessorParameters processorParameters, Action<IFileValue> push, CancellationToken cancellationToken)
    {
