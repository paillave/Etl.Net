...
public class PdfHeader(IFileValue fileValue, List<string> section, int pageNumber) : PdfContent(section, pageNumber, fileValue)
{
}
...
public class PdfRowsValuesProvider(PdfRowsValuesProviderArgs args) : ValuesProviderBase<IFileValue, PdfContent>
{
    private readonly PdfRowsValuesProviderArgs _args = args;
