...
public class SftpFileValueProcessor(string code, string name, string connectionName, SftpAdapterConnectionParameters connectionParameters, SftpAdapterProcessorParameters processorParameters) : FileValueProcessorBase<SftpAdapterConnectionParameters, SftpAdapterProcessorParameters>(code, name, connectionName, connectionParameters, processorParameters)
{
