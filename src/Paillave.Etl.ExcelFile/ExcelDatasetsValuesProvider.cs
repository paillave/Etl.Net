...
public class ExcelDatasetsValuesProvider<TOut>(ExcelDatasetsValuesProviderArgs<TOut> args) : ValuesProviderBase<IFileValue, TOut>
{
    private readonly ExcelDatasetsValuesProviderArgs<TOut> _args = args;
