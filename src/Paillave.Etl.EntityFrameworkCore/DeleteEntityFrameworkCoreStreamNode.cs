...
public class DeleteEntityFrameworkCoreStreamNode<TIn, TValue, TEntity>(string name, DeleteEntityFrameworkCoreArgs<TIn, TValue, TEntity> args) : StreamNodeBase<TIn, IStream<TIn>, DeleteEntityFrameworkCoreArgs<TIn, TValue, TEntity>>(name, args)
    where TEntity : class
{
