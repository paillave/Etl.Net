...
namespace Paillave.Etl.Zip
{
    ...
    {
        public static IStream<IFileValue> CrossApplyZipFiles(this IStream<IFileValue> stream, string name, string pattern = "*", string password = null, bool noParallelisation = false, bool useStreamCopy = false)
