...
namespace Paillave.Etl.Core.MapperFactories
{
    ...
    {
        public static ColumnIndexMappingConfiguration<TDest> ColumnIndexStringParserMappers<TDest>() where TDest : new()
        {
            return new ColumnIndexMappingConfiguration<TDest>(() => new TDest());
        }
