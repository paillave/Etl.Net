...
{
    public class ToResourceStreamArgsBase<TResource> where TResource : IDisposable
    {
        public IStream<TResource> OutputResourceStream { get; set; }
    }
        ...
        where TArgs : ToResourceStreamArgsBase<TResource>
    {
        ...
        {
            this.Arguments.OutputResourceStream.Observable.First().Subscribe(this.UnstackValues);
        }
