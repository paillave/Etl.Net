...
public class HttpFileValueProvider : FileValueProviderBase<HttpAdapterConnectionParameters, HttpAdapterProviderParameters>
{
    ...
    protected override void Provide(Action<IFileValue> pushFileValue, HttpAdapterConnectionParameters connectionParameters,
    ...
    private static Task<HttpResponseMessage> GetResponse(HttpAdapterConnectionParameters connectionParameters,
                                                         HttpAdapterProviderParameters providerParameters,
                                                         HttpClient httpClient)
    {
        return providerParameters.Method switch
        {
            ...
            "Post" => httpClient.PostAsync(connectionParameters.Url, HttpRequestBodyEx.GetJsonBody(providerParameters.Body)),
