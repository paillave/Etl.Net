...
{
    private readonly SingleDisposableManager _disposable = new();
    private readonly IDisposable _subscription;
    private bool _hasValue = false;
    private DicoAggregateElement<TIn, TAggr> _currentAggregation = new();
    private readonly object _lockSync = new();
    private readonly Func<TIn, TAggr, TOut> _resultSelector;
