...
public class GroupSubject<TIn, TKey, TOut> : PushSubject<TOut>
{
    ...
    private readonly IDisposableManager _outSubscriptions = new CollectionDisposableManager();
    private readonly Dictionary<TKey, KeyGroup> _observableDictionary = new();
