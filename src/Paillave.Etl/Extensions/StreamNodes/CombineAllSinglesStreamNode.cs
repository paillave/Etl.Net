...
namespace Paillave.Etl.Core
{
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TOut> args) : base(name, args) { }
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TIn3, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TOut> args) : base(name, args) { }
        public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
        public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TIn3, TIn4, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TOut> args) : base(name, args) { }
        public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
        public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TIn3, TIn4, TIn5, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TOut> args) : base(name, args) { }
        public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
        public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut> args) : base(name, args) { }
        public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
        public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
    ...
    public class CombineAllSinglesStreamNode<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut> : StreamNodeBase<TOut, ISingleStream<TOut>, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut>>
    {
        public CombineAllSinglesStreamNode(string name, CombineAllSinglesArgs<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut> args) : base(name, args) { }
        public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
        public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
