...
public class GroupByCorrelatedStreamNode<TIn, TKey, TOut>(string name, GroupByCorrelatedArgs<TIn, TKey, TOut> args) : StreamNodeBase<Correlated<TOut>, IStream<Correlated<TOut>>, GroupByCorrelatedArgs<TIn, TKey, TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
...
public class GroupByCorrelatedSortedStreamNode<TIn, TKey, TOut>(string name, GroupByCorrelatedSortedArgs<TIn, TKey, TOut> args) : StreamNodeBase<Correlated<TOut>, IStream<Correlated<TOut>>, GroupByCorrelatedSortedArgs<TIn, TKey, TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
