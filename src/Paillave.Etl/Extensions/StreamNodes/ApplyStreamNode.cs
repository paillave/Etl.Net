...
public class ApplyStreamNode<TInMain, TInToApply, TOut>(string name, ApplyArgs<TInMain, TInToApply, TOut> args) : StreamNodeBase<TOut, IStream<TOut>, ApplyArgs<TInMain, TInToApply, TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
