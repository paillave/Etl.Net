...
public class PivotCorrelatedStreamNode<TIn, TAggrRes, TKey>(string name, PivotCorrelatedArgs<TIn, TAggrRes, TKey> args) : StreamNodeBase<Correlated<AggregationResult<TIn, TKey, TAggrRes>>, IStream<Correlated<AggregationResult<TIn, TKey, TAggrRes>>>, PivotCorrelatedArgs<TIn, TAggrRes, TKey>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Heavy;
    ...
    protected override IStream<Correlated<AggregationResult<TIn, TKey, TAggrRes>>> CreateOutputStream(PivotCorrelatedArgs<TIn, TAggrRes, TKey> args)
    {
        ...
        return CreateUnsortedStream(
            args.InputStream.Observable.Aggregate(
                ...
                (i, k, a) =>
                {
                    HashSet<Guid> correlationKeys = new();
...
public class PivotSortedCorrelatedStreamNode<TIn, TAggrRes, TKey>(string name, PivotSortedCorrelatedArgs<TIn, TAggrRes, TKey> args) : StreamNodeBase<Correlated<AggregationResult<TIn, TKey, TAggrRes>>, ISortedStream<Correlated<AggregationResult<TIn, TKey, TAggrRes>>, TKey>, PivotSortedCorrelatedArgs<TIn, TAggrRes, TKey>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
