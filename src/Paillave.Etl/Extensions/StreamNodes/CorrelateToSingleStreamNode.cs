...
public class CorrelateToManyStreamNode<TInLeft, TInRight, TOut>(string name, CorrelateArgs<TInLeft, TInRight, TOut> args) : StreamNodeBase<Correlated<TOut>, IStream<Correlated<TOut>>, CorrelateArgs<TInLeft, TInRight, TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Average;
