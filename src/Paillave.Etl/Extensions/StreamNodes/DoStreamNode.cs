...
{
    void ProcessRow(TIn value, IServiceProvider services, CancellationToken cancellationToken);
}
public class SimpleDoProcessor<TIn, TInnerIn>(Func<TIn, TInnerIn> getInner, Action<TInnerIn, IServiceProvider> processRow) : IDoProcessor<TIn>
{
    public void ProcessRow(TIn value, IServiceProvider services, CancellationToken cancellationToken)
        => processRow(getInner(value), services);
}
...
public class DoStreamNode<TIn, TStream>(string name, DoArgs<TIn, TStream> args) : StreamNodeBase<TIn, TStream, DoArgs<TIn, TStream>>(name, args) where TStream : IStream<TIn>
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
    public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
    protected override TStream CreateOutputStream(DoArgs<TIn, TStream> args)
        => base.CreateMatchingStream(args.Stream.Observable.Do(i => args.Processor.ProcessRow(i,args.Stream.SourceNode.ExecutionContext.Services, CancellationToken.None)), args.Stream);
}
#endregion
...
//     public void ProcessRow(TIn value, IServiceProvider , CancellationToken cancellationToken, IExecutionContext context)
//     {
//         lock (_lock)
//         {
//             if (_service == null)
//             {
//                 _service = context.Services.Resolve<TService>();
//             }
//         }
//         if (_actionFull != null)
//         {
