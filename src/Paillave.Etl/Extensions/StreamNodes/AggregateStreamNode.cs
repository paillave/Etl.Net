...
public class AggregateCorrelatedStreamNode<TIn, TAggrRes, TKey>(string name, AggregateCorrelatedArgs<TIn, TAggrRes, TKey> args) : StreamNodeBase<Correlated<AggregationResult<TIn, TKey, TAggrRes>>, IStream<Correlated<AggregationResult<TIn, TKey, TAggrRes>>>, AggregateCorrelatedArgs<TIn, TAggrRes, TKey>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Average;
...
public class AggregateStreamNode<TIn, TAggrRes>(string name, AggregateArgs<TIn, TAggrRes> args) : StreamNodeBase<TAggrRes, IStream<TAggrRes>, AggregateArgs<TIn, TAggrRes>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Average;
