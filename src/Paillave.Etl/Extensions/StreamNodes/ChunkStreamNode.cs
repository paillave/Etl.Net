...
public class ChunkCorrelatedStreamNode<TIn>(string name, ChunkCorrelatedArgs<TIn> args) : StreamNodeBase<Correlated<IEnumerable<TIn>>, IStream<Correlated<IEnumerable<TIn>>>, ChunkCorrelatedArgs<TIn>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Light;
