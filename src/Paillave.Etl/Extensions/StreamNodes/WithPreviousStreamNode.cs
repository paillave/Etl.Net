...
public class WithPreviousStreamNode<TIn, TOut>(string name, WithPreviousArgs<TIn, TOut> args) : StreamNodeBase<TOut, IStream<TOut>, WithPreviousArgs<TIn, TOut>>(name, args)
{
...
public class WithPreviousCorrelatedStreamNode<TIn, TOut>(string name, WithPreviousCorrelatedArgs<TIn, TOut> args) : StreamNodeBase<Correlated<TOut>, IStream<Correlated<TOut>>, WithPreviousCorrelatedArgs<TIn, TOut>>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Average;
    public override ProcessImpact MemoryFootPrint => ProcessImpact.Light;
