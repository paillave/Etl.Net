...
public class Aggregator<TIn>(Type aggregatorInstanceType, PropertyInfo sourcePropertyInfo, PropertyInfo targetPropertyInfo) : AggregatorBase<TIn, TIn>(aggregatorInstanceType, sourcePropertyInfo, targetPropertyInfo)
{
...
public class CorrelatedAggregator<TCorrelated>(Type aggregatorInstanceType, PropertyInfo sourcePropertyInfo, PropertyInfo targetPropertyInfo) : AggregatorBase<Correlated<TCorrelated>, TCorrelated>(aggregatorInstanceType, sourcePropertyInfo, targetPropertyInfo)
{
    public HashSet<Guid> CorrelationKeys = new();
