...
public class ValueProviderWrapper<TIn, TInnerIn, TInnerOut, TOut>(IValuesProvider<TInnerIn, TInnerOut> innerValueProvider, Func<TIn, TInnerIn> getInnerIn, Func<TInnerOut, TIn, TOut> getOut) : IValuesProvider<TIn, TOut>
{
    private readonly IValuesProvider<TInnerIn, TInnerOut> _innerValueProvider = innerValueProvider;
