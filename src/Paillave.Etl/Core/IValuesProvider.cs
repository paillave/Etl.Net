...
namespace Paillave.Etl.Core
{
    ...
    {
        string TypeName { get; }
        void PushValues(TValueIn input, Action<TValueOut> push, CancellationToken cancellationToken, IExecutionContext context);
    ...
    public abstract class ValuesProviderBase<TValueIn, TValueOut> : IValuesProvider<TValueIn, TValueOut>
    {
        ...
        public abstract void PushValues(TValueIn input, Action<TValueOut> push, CancellationToken cancellationToken, IExecutionContext context);
    ...
    {
        string TypeName { get; }
        void PushValues(TValueIn input, TInToApply toApply, Action<TValueOut> push, CancellationToken cancellationToken, IExecutionContext context);
        ProcessImpact PerformanceImpact { get; }
        ProcessImpact MemoryFootPrint { get; }
    }
    public abstract class ValuesProviderBase<TValueIn, TInToApply, TValueOut> : IValuesProvider<TValueIn, TInToApply, TValueOut>
    {
        ...
        public abstract ProcessImpact PerformanceImpact { get; }
        public abstract ProcessImpact MemoryFootPrint { get; }
        public abstract void PushValues(TValueIn input, TInToApply toApply, Action<TValueOut> push, CancellationToken cancellationToken, IExecutionContext context);
    }
}