...
{
    public static SimpleValuesProvider<TIn, TOut> Create<TIn, TOut>(Action<TIn, CancellationToken, Action<TOut>> pushValues) => new(pushValues);
    public static SimpleValuesProvider<TIn, TOut> Create<TIn, TOut>(Action<TIn, IExecutionContext, CancellationToken, Action<TOut>> pushValues) => new(pushValues);
...
{
    private readonly Action<TIn, IExecutionContext, CancellationToken, Action<TOut>> _pushValuesWithResolver = null;
    private readonly Action<TIn, CancellationToken, Action<TOut>> _pushValues = null;
