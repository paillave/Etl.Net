...
public class SimpleLinesMethod(WordExtractionType wordExtractionType, Areas areas) : ExtractMethod(wordExtractionType)
{
    ...
    private class ProcessingLines(Areas areas)
    {
        private readonly List<ProcessingLine> _processingLines = new();
        private readonly Areas _areas = areas;
