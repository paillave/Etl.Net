...
public class Grid(double proximity = 0) : IBounds
{
    ...
    private readonly List<GridLine> _relatedLines = new();
    private List<GridLine> _simplifiedRelatedLines = new();
    private List<GridLine> _cellLines = new();
