...
[Obsolete("KISS & YAGNI")]
public class WriteToFileStreamNode<TParams>(string name, WriteToFileArgs<TParams> args) : StreamNodeBase<IFileValue, IStream<IFileValue>, WriteToFileArgs<TParams>>(name, args)
{
...
/// </summary>
/// <typeparam name="TParams"></typeparam>
public class WriteToFileStreamNode(string name, WriteToFileArgs args) : StreamNodeBase<IFileValue, IStream<IFileValue>, WriteToFileArgs>(name, args)
{
    public override ProcessImpact PerformanceImpact => ProcessImpact.Heavy;
    public override ProcessImpact MemoryFootPrint => ProcessImpact.Heavy;
